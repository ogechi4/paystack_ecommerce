...
function Add({ token }) {
    ...
    const addSize = () => {
        if (customSize && !sizes.includes(customSize)) {
            ...
            toast.error('Size already added or invalid');
        }
    };
                ...
                {subCategory === 'Shoes' ? (
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <button type="button" onClick={addSize} className="px-3 py-2 bg-black text-white">
                                Add Size
                            </button>
                        </div>
                        <div className="flex gap-3 flex-wrap">
                            {sizes.map((size) => (
                                <div key={size} className="flex items-center gap-2">
                                    <p className="px-3 py-1 bg-pink-200">{size}</p>
                                    <button
                                        type="button"
